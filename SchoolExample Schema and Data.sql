...
BEGIN
CREATE TABLE [dbo].[Departments]([DepartmentID] [int] NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[Persons]([PersonID] [int] IDENTITY(1,1) NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[OnSiteCourses]([CourseID] [int] NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[OnlineCourses]([CourseID] [int] NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[StudentGrades]([EnrollmentID] [int] IDENTITY(1,1) NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[CourseInstructors]([CourseID] [int] NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[Courses]([CourseID] [int] NOT NULL,
...
BEGIN
CREATE TABLE [dbo].[OfficeAssignments]([InstructorID] [int] NOT NULL,
[Location] [nvarchar](50) NOT NULL,
...
ALTER TABLE [dbo].[OnSiteCourses] WITH CHECK ADD
CONSTRAINT [FK_OnsiteCourse_Course] FOREIGN KEY([CourseID])
REFERENCES [dbo].[Courses] ([CourseID])
GO
ALTER TABLE [dbo].[OnSiteCourses] CHECK
CONSTRAINT [FK_OnsiteCourse_Course]
GO

-- Define the relationship between OnlineCourse and Course.
ALTER TABLE [dbo].[OnlineCourses] WITH CHECK ADD
CONSTRAINT [FK_OnlineCourse_Course] FOREIGN KEY([CourseID])
REFERENCES [dbo].[Courses] ([CourseID])
GO
ALTER TABLE [dbo].[OnlineCourses] CHECK
CONSTRAINT [FK_OnlineCourse_Course]
GO

-- Define the relationship between StudentGrade and Course.
ALTER TABLE [dbo].[StudentGrades] WITH CHECK ADD
CONSTRAINT [FK_StudentGrade_Course] FOREIGN KEY([CourseID])
REFERENCES [dbo].[Courses] ([CourseID])
GO
ALTER TABLE [dbo].[StudentGrades] CHECK
...
ALTER TABLE [dbo].[OfficeAssignments] WITH CHECK ADD
CONSTRAINT [FK_OfficeAssignment_Person] FOREIGN KEY([InstructorID])
REFERENCES [dbo].[Persons] ([PersonID])
GO
ALTER TABLE [dbo].[OfficeAssignments] CHECK
...
GO
INSERT INTO dbo.Persons (PersonID, LastName, FirstName, HireDate, EnrollmentDate, Discriminator)
...
INSERT INTO dbo.Departments (DepartmentID, [Name], Budget, StartDate, Administrator)
...
INSERT INTO dbo.Courses (CourseID, Title, Credits, DepartmentID)
...
INSERT INTO dbo.OnlineCourses (CourseID, URL)
...
INSERT INTO dbo.OnsiteCourses (CourseID, Location, Days, [Time])
...
INSERT INTO dbo.CourseInstructors(CourseID, PersonID)
VALUES (1050, 1);
INSERT INTO dbo.CourseInstructors(CourseID, PersonID)
VALUES (1061, 31);
INSERT INTO dbo.CourseInstructors(CourseID, PersonID)
...
INSERT INTO dbo.OfficeAssignments(InstructorID, Location)
VALUES (1, '17 Smith');
INSERT INTO dbo.OfficeAssignments(InstructorID, Location)
VALUES (4, '29 Adams');
INSERT INTO dbo.OfficeAssignments(InstructorID, Location)
...
INSERT INTO dbo.StudentGrades (CourseID, StudentID, Grade)
VALUES (2021, 2, 4);
INSERT INTO dbo.StudentGrades (CourseID, StudentID, Grade)
VALUES (2030, 2, 3.5);
INSERT INTO dbo.StudentGrades (CourseID, StudentID, Grade)
